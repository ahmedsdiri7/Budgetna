...
import { MENU_ITEMS_SU } from './pages-menu-su';
    ...
    this.empService.getEmployeByEmail(localStorage.getItem('email')).subscribe(data => 
      {
        ...
        this.menu = MENU_ITEMS_ADMIN;
        }else if (this.emp.role === "INGENIEUR") {
          this.menu = MENU_ITEMS_SU;  // Utilisation du menu pour les superviseurs
        }
    else {
      this.menu = MENU_ITEMS;  // Menu par défaut pour les autres rôles
    }
  },
  err => {
